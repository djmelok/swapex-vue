...
.signup
  ...
  form.signup__form(@submit="checkForm")
    .signup__form-title
      span Регистрация
    input.signup__form-input(v-model="key", type="hidden", name="ref", readonly)
    input.signup__form-input(v-model="email", type="email", placeholder="E-mail", required)
    input.signup__form-input(v-model="password", type="password", placeholder="Пароль", required)
    input.signup__form-input(v-model="passwordAgain", type="password", placeholder="Повторный пароль", required)
